...
<body class="sb-nav-fixed">
	...
	<%@include file="/WEB-INF/views/quantri/quanlisanpham.jsp"%>
...
<!-- 	<script src="https://code.jquery.com/jquery-3.3.1.min.js"></script> -->
    ...
    <content tag="script"> <script type="text/javascript">
		...
		function myFunction(id) {
            ...
            if (r == true) {
                window.location.href= "http://localhost:8080/quan-tri/quan-ly-san-pham/xoa-san-pham/"+id;
            } else{
		...
		function locSanPham(){
			var id = $( "#loc" ).val();
			window.location.href= "http://localhost:8080/quan-tri/quan-ly-san-pham/loc-san-pham/"+id+"?page=1&limit=12";
		};
	</script> </content>
</body>
</html>